					...
					<tr class="customer__table--body">
						...
						<td  class="customer__table--body-item" ><?php echo $row['size']?></td>
						 <td  class="customer__table--body-item" > 
							...
							<a  href="Suasanpham.php?idkh=<?php echo $row['id']?>"   class="customer__table--body-btn-upd" >Sửa</a>
							<a href="Xoasanpham.php?idkh=<?php echo $row['id']?>" class="customer__table--body-btn-del">Xóa</a>
						 </td>
					</tr>
                     <?php
					 }
