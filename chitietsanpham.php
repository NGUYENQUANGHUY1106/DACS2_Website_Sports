                    ...
                    <form action="xulylogin.php" method="POST" class="auth_form__login" id="login">
                        ...
                        <div class="auth-form__controls">
                            ...
                            <div class="auth-form__socials ">
                                ...
                                <a href="https://www.instagram.com/qua_nghuy11/" class="auth-form__socials--google btn btn--size-s btn--with-icon">
                                    <i class="auth-form__socials-icon fa-brands fa-google"></i>
                                    <span class="auth-form__socials-title">
                                        Kết nối với Google
                                    </span>
                                    ...
                                    <div class="detail__container" id="detail-id">
                                        ...
                                        <div class="detail__content">
                                                        ...
                                                        <li class="detail__classify-item">
                                                            <div class="detail__classify-item__content">
                                                                <div class="detail__classify-item-img">
                                                                    <!-- Thêm sự kiện onclick để thay đổi hình ảnh chính -->
                                                                    <img style="width: 60px; height: 60px;" src="<?php echo $img; ?>" alt=""
                                                                        onclick="document.getElementById('detail__img-id').style.backgroundImage = 'url(<?php echo $img; ?>)'">
                                                                </div>
                                                            </div>
                                                        </li>
                                                    <?php } ?>
                                            ...
                                            <div class="detail__classify" id="detail__classify_size">
                                                ...
                                                <ul class="detail__classify-list" id="detail_classify_list_size">
                                            ...
                                            <form class="detail__select" id="btn-addcartid" method="POST">
                                                <a href="themgiohang.php?item=<?php echo $row['id']; ?>" name="addedCart" id="added-id" class="detail__select-addCart">
