                ...
                <div class="cart__form-productDetails">
                    ...
                    <div class="cart__form-productDetails__quantity-container">        
                        <div class="detail__quantity-content">
                            ...
                            <a href="giamgiohang.php?item=<?php echo $row['id']?>" class="detail__quantity-content__minus" ><i style="color: red;" class="fa-solid fa-minus detail__quantity-content__minus-icon" ></i></a>
                            ...
                            <a href="muangay.php?item=<?php echo $row['id']?>" class="detail__quantity-content__add" "><i class="fa-solid fa-plus" style="color:red;"></i></a>              
                        </div>    
                    </div>
                    <span class="cart__form-productDetails__total" id="total-Price"><?php echo number_format($total,0).'đ'?></span>
