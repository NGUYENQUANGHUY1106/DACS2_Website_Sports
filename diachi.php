...
<div class="app">
   ...
   <div class="app__container">
        <div class="address__container">
            <div class="address__content">
                ...
                <div class="address__content__body">
                    ...
                    <a href="xoadiachi.php" class="address__content__body--del">Xóa</a>
            </div>
        </div>
    </div>
      <?php
      ...
      ?>   
      <!-- form địa chỉ -->
      <form class="show__form__address" id="address-Id" action="xulyFormdiachi.php" method="POST">
            ...
            <div class="container__form-address">
                <div class="content__form-address">
                    ...
                    <div class="content__form-address--button">
                        <a href="diachi.php" id="address__back--btn" class=" btn content__form-address__button--return">Trở Lại</a>
