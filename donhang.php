...
<table align="center" border="1px" cellspacing="0px" class="customer__table">
                    ...
                    <td class="customer__table--item" >Id khách hàng</td>
					...
					<td class="customer__table--item" >Thành Phố</td>
					<td class="customer__table--item" >Quận,Huyện</td>
                    <td class="customer__table--item" >Phường,xã</td>
					<td class="customer__table--item" >Địa chỉ</td>
...
while ($row = mysqli_fetch_array($result)) {
    ...
    // Giả sử product_details là một mảng và bạn lấy hình ảnh của sản phẩm đầu tiên
    if (!empty($product_details)) {
        $first_item = $product_details[0]; // Lấy sản phẩm đầu tiên trong giỏ hàng (hoặc bạn có thể lấy theo cách khác nếu cần)
    } else {
        $product_image = ''; // Nếu không có hình ảnh, có thể để trống hoặc dùng hình ảnh mặc định
    }
?>
    <tr class="customer__table--body">
        <td class="customer__table--body-item"><?php echo $row['order_id']; ?></td>
        <td style="width:50px" class="customer__table--body-item"><?php echo $row['customer_id']; ?></td>
        <td class="customer__table--body-item"><?php echo $row['customer_name']; ?></td>
        <td class="customer__table--body-item"><?php echo $row['product_details']; ?></td>
        <td class="customer__table--body-item"><?php echo $row['customer_phone']; ?></td>
        <td class="customer__table--body-item"><?php echo $row['customer_city']; ?></td>
        <td class="customer__table--body-item"><?php echo $row['customer_district']; ?></td>
        <td class="customer__table--body-item"><?php echo $row['customer_ward']; ?></td>
        <td class="customer__table--body-item"><?php echo $row['customer_address']; ?></td>
        <td class="customer__table--body-item"><?php echo $row['total_amount']; ?></td>
