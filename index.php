...
<body>
                ...
                <nav class="header__navbar">
                    <ul class="header__navbar-list">
                        <li class="header__navbar-item header__navbar-item--has-qr header__navbar-item-separate">
                            Vào cửa hàng trong ứng dụng QUANGHUYSPORTS
                            <!-- QR code -->
                                    ...
                                    <div class="auth-form__container">
                                        ...
                                        <div class="auth-form__aside">
                                            <p class="auth-form__policy-text">
                                                Bằng việc đăng ký. bạn đã đồng ý với QUANGHUYSPORTS về
        ...
        <div class="app__container">
                ...
                <div class="grid__row app__content">
                            ...
                            <nav class="category">
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        // Kiểm tra danh mục đang được chọn
                                        $active_class = (isset($_GET['iddm']) && $_GET['iddm'] == $row['id']) ? 'category-item--active' : '';
                    ...
                    <div class="grid__column-10">
                        <form method="POST" action="index.php" class="home-filter">
                            ...
                            <button type="submit" name="top_sold" value="1" class="home-filter-btn btn active">Sản Phẩm Bán Chạy</button>
                        ...
                        <div class="home-product">
                            <div class="grid">
                                <div class="row">
                                    ...
                                    // Kiểm tra iddm
                                    $iddm = isset($_GET['iddm']) ? intval($_GET['iddm']) : null;
                                    ...
                                    if ($iddm) {
                                        $countSql = "SELECT COUNT(id) AS total FROM SANPHAM WHERE iddm = $iddm";
                                    } else {
                                    ...
                                    if ($iddm) {
                                        $sql = "SELECT *, ((priceOld - priceNew) / priceOld * 100) AS priceDiscount 
            FROM SANPHAM 
            WHERE iddm = $iddm 
            LIMIT $start, $limit";
                                    } else {
            ...
            LIMIT $start, $limit";
                                    ...
                                    ?>
                                        ...
                                        <a href="chitietsanpham.php?idsp=<?php echo $row['id']; ?>" class="col l-2-5 m-4 c-6 product__item-id" style="text-decoration: none;">
                                            <div class="home-product-item" style="position: relative; margin: 20px auto;">
                                                <!-- Ảnh lớn -->
                                                <div class="main-image home-product-item-img" style="background-image: url('<?php echo $row['urlImg']; ?>'); background-size: cover; background-position: center; height: 200px; width: 100%; border: 1px solid #ddd;"></div>

                                                <!-- Ảnh nhỏ -->
                                                <div style="display: flex; gap: 10px; justify-content: center; margin-top: 10px;">
                                                    <div>
                                                        <img src="<?php echo $row['urlImg']; ?>" alt="Image 1" data-img="<?php echo $row['urlImg']; ?>" class="thumbnail" style="width: 40px; height: 40px; cursor: pointer; border: 1px solid #ddd;">
                                                    </div>
                                                    <div>
                                                        <img src="<?php echo $row['img_sub1']; ?>" alt="Image 2" data-img="<?php echo $row['img_sub1']; ?>" class="thumbnail" style="width: 40px; height: 40px; cursor: pointer; border: 1px solid #ddd;">
                                                    </div>
                                                    <div>
                                                        <img src="<?php echo $row['img_sub2']; ?>" alt="Image 3" data-img="<?php echo $row['img_sub2']; ?>" class="thumbnail" style="width: 40px; height: 40px; cursor: pointer; border: 1px solid #ddd;">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="home-product-item__sale-off">
                                                    <span class="home-product-item__sale-off-percent"><?php echo intval($row['discount']) . '%'; ?></span>
    ...
    list-style: none; 
    padding: 0;
    margin: 20px auto; " class="Pagination home-product__Pagination">
                                        <?php
                                        if ($current_page > 1 && $total_page > 1) {
                                            echo '<li class="Pagination-item"><a href="index.php?page=' . ($current_page - 1) .
                                                ($iddm ? '&iddm=' . $iddm : '') .
                                                '" class="Pagination-item__link"><i class="Pagination-item__icon fa-solid fa-chevron-left"></i></a></li>';
                                        }
                                        for ($i = 1; $i <= $total_page; $i++) {
                                            if ($i == $current_page) {
                                                echo '<li class="Pagination-item"><span class="Pagination-item__link" style="background-color: red; color: var(--white-color); border-radius: 50%;">' . $i . '</span></li>';
                                            } else {
                                                echo '<li class="Pagination-item"><a href="index.php?page=' . $i .
                                                    ($iddm ? '&iddm=' . $iddm : '') .
                                                    '" class="Pagination-item__link">' . $i . '</a></li>';
                                            }
                                        }
                                        if ($current_page < $total_page && $total_page > 1) {
                                            echo '<li class="Pagination-item"><a href="index.php?page=' . ($current_page + 1) .
                                                ($iddm ? '&iddm=' . $iddm : '') .
                                                '" class="Pagination-item__link"><i class="Pagination-item__icon fa-solid fa-chevron-right"></i></a></li>';
                                        }
                                        ?>
                                    </ul>
                            ...
                            <div class="grid">
                                <div class="row">
                                    ...
                                    <div class="col l-3 m-6 c-12">
                                        <div class="footer-content">
                                            <div class="">
                                                <h3 class="footer-heading">VỀ QUANGHUYSPORTS</h3>
                                                <ul class="footer-list">
                                                    <li class="footer-item">
                                                        <a href="" class="footer-item__link">
                                                            Giới thiệu về QUANGHUYSPORTS
                                                        </a>
                                                    </li>
                                                    <li class="footer-item">
                                                        <a href="" class="footer-item__link">
                                    ...
                                    <div class="col l-3 m-6 c-12">
                                        <div class="footer-content">
                                            <div class="">
                                                <h3 class="footer-heading">THEO DÕI QUANGHUYSPORTS</h3>
                                                <ul class="footer-list">
                                                    <li class="footer-item">
                                                        <a href="" class="footer-item__link">
                            ...
                            <div class="footer__bottom">
                                <div class="grid">
                                    ...
                                    <div class="footer-infor__logo">
                                        ...
                                        <span class="footer-infor__logo-text">Công ty TNHH QUANGHUYSPORTS</span>
                                    </div>
                                    <div class="footer-infor__Address">
                                        ...
                                        <span class="footer-infor__Address-item">
                                            &reg;2023-Bản quyền thuộc về công ty QUANGHUYSPORTS
                                        </span>
                                    </div>
